              ...
              {isLoading ? (
                ...
                <div className="flex justify-center my-4">
                  <Text size="5xl" classname="capitalize">
                    know who <span className="text-baseCol font-bold">I'm</span>
                  </Text>
                </div>
              )}
              {isLoading ? (
                ...
                <div>
                  <Text size="sm">
                    ✅ Hi There, This is{" "}
                    <span className="text-baseCol font-bold">Rohit Prasad</span>
                    . Born & brought up in{" "}
                    <span className="text-baseCol">Kolkata 🇮🇳 .</span>
                  </Text>
                  <Text size="sm">
                    ✅
                    <span className="text-baseCol font-bold"> 2021 BTECH</span>{" "}
                    Graduate 🎓 in{" "}
                  ...
                  <Text size="sm">
                    ...
                    solid foundation of{" "}
                    <span className="font-bold text-baseCol">3+ years</span> of
      ...
      <Container>
        <div className="flex flex-col gap-8 w-full">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-6 gap-8">
            ...
            />
            <SkillCard icon={SiLinux} size="60" path="https://www.linux.org/" />
            <SkillCard
              icon={SiMacos}
              size="60"
