    ...
    <Router>
      ...
      <div className="text-white bg-[#0c1a22] w-full" id={isLoading ? "no-scroll" : "scroll"}>
        ...
        <Routes>
          ...
          <Route path='/experience' element={<Experience setPath={setActivePath} />} />
      ...
      <div className="bg-gray-800 text-white flex justify-center py-4 text-[16px] lg:text-[20px]">Made with ❤️ by Rohit Prasad</div>
    </Router>
  );
}
